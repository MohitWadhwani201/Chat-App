		...
		<>
			<TooltipProvider>
				<Tooltip>
					<TooltipTrigger>
						<FaPlus
							className="text-neutral-500 font-light text-opacity-90 text-start hover:text-neutral-100 cursor-pointer tranistion-all duration-300"
			...
			<Dialog open={openNewContact} onOpenChange={setOpenNewContact}>
				...
				<DialogContent className="bg-[#181920]  border-none text-white    w-[400px] h-[400px] flex flex-col">
					...
					{searchedContacts.length <= 0 && (
						<div className="flex-1 mt-5 lg:mt-0 md:bg-[#1c1d25] md:flex flex-col justify-center items-center  duration-1000 transition-all">
							<Lottie
